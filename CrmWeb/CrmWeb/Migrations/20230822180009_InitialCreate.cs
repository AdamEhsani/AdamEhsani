        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceXL = table.Column<int>(type: "int", nullable: false),
                    PriceXXL = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraItems = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillDetail_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillDetail_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillDetail_OrderId",
                table: "BillDetail",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_BillDetail_ProductsId",
                table: "BillDetail",
                column: "ProductsId");
